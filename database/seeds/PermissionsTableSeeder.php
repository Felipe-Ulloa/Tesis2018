    ...
    public function run()
    {
        ...
        $permisos = [
            ...
            //otros
                ...
                ['60','Ver Reportes Generales','reports.especificos','Ver Reportes Generales'],
                ['61','Ver Home','home','Ver el Home'],
                ['62','Ver Home paciente','intranetpaciente.homepaciente','Ver el Home solo paciente'],
                ['63','Ver Perfil','users.showprofile','Ver perfil de usuario'],
                ['64','Ver ficha','sessions.ficha','Ver ficha'],
                ['65','Cambiar Contraseña','users.password','Cambiar Contraseña'],
                ['66','Cambiar Contraseña update','users.updatepassword','Update Contraseña'],
                ['67','Ver pestaña usuarios','pestaña.usuarios','Pestaña de usuarios'],
                ['68','Ver pestaña reportes','pestaña.reportes','Pestaña de reportes'],
                ['68','Acceso directo del paciente',' acceso.paciente','Opciones del paciente'],
