...
Route::get('intranetpaciente/homepaciente', 'HomeController@indexpaciente')->name('intranetpaciente.homepaciente');
...
Route::get('reports/especificos','ReportController@especific')->name('reports.especifico')
	...
	Route::post('users/updatepassword','UserController@updatepassword')->name('users.updatepassword')
			->middleware('permission:users.updatepassword');
	...
	Route::get('profile/{user}','UserController@showprofile')->name('users.showprofile')
			->middleware('permission:users.showprofile');
	...
	Route::get('pdfdownload/{session}', function () {
			$pdf = PDF::loadView('sessions.ficha');
	...
	//Ver formulario de creacion
	Route::get('activities/create/{observationid}','ActivityController@create')->name('activities.create')
			->middleware('permission:activities.create');
	...
	//Ver formulario de edicion
	Route::get('activities/{activity}/editpaciente','ActivityController@editpaciente')->name('activities.editpaciente');
	//		->middleware('permission:activities.editpaciente');

	// actualizar
	Route::put('activitiespaciente/{activity}','ActivityController@updatepaciente')->name('activities.updatepaciente');
	// ->middleware('permission:activities.edit');

			
	//Ver actividades pendiente			
	Route::get('activities/','ActivityController@pendiente')->name('activities.pendiente');

	//Ver actividades pendiente			
	Route::get('/expresions.create','ExpresionController@create')->name('expresions.create');
	Route::post('expresions/store','ExpresionController@store')->name('expresions.store');

	//Ver formulario de creacion
	Route::get('expresions/index/{observationid}','ExpresionController@index')->name('expresions.index');	
	Route::get('/contaralgo','ExpresionController@')->name('contaralgo');
