...
class HistorialController extends Controller
{
    ...
    public function store(Request $request)
    {
       $historial = Historial::create($request->all());
        ...
        return redirect()->route('historials.show',$historial->sesion_id)
    ...
    public function show(Historial $historial, $id)
    {
        ...
        return view('historials.show',compact('historials','idsesion'));
    ...
    public function update(Request $request, Historial $historial)
    {
        ...
        return view('sessions.index',compact('historial'));
