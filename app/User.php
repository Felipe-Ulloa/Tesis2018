...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'apellidos', 'email', 'password', 'rut', 'telefono', 'sexo', 'fechanacimiento', 'region_id', 'comuna_id', 'direccion', 'nivelse_id', 'fonasa_id', 'estado_id', 'user_types_id', 'institute_id',
    ];
