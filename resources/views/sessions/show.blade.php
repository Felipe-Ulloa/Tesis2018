                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-sm">
                        <thead>
                            ...
                            <tr>
                                    <td>
                                        Relatos y observaciones del usuario
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('expresions.index', $session->id) }}" 
                                        class="btn btn-raised bg-yellow btn-sm"> 
                                        <i class="fas fa-list-ul"></i>
                                        Expresiones
                                    </a>
                                    </td>
                ...
                @endcan
                 ...
                 <!-- otro más </!-->
                    ...
                    @can('activities.create')
                        <a href="{{route('activities.create', $session->id)}}" 
                            class="btn btn-raised btn-info"> 
                            <i class="fas fa-plus"> 
                            </i> Nueva Actividad 
                        </a>
                    ...
                    <div class="card">
                            <div class="card-header">
                                <div class="card-title text-center text-uppercase"> <h5>Reporte de Actividades</h5> </div>
                               <!-- Styles -->
                                <style>
                                #actividades {
                                  width: 100%;
                                ...
                                <!-- Chart code -->
                                <script>
                                var chart = AmCharts.makeChart("actividades", {
                                  "type": "serial",
                                  "theme": "light",
                                  "marginRight": 70,
                                  "dataProvider": [
                                  {
                                    "country": "Pendiente",
                                    "visits": {{ $contadorpendiente }},
                                    "color": "#FF0F00"
                                  }, {
                                    "country": "Realizado",
                                    "visits": {{ $contadorrealizadas }},
                                    "color": "#FF6600"
                                  }
                                  ],
                                  "valueAxes": [{
