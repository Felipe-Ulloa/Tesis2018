...
<div class="row">
	<div class="col">
		<div class="form-group">
	{{ Form::label('rut', 'Rut') }}
	{{ Form::text('rut', null, ['class' => 'form-control', 'maxlength' =>  10, 'placeholder' => '11111111-1']) }}
</div>
...
<div class="form-group">
	...
	{{ Form::text('telefono', null, ['class' => 'form-control', 'maxlength' =>  10 , 'placeholder' => '999999999']) }}
</div>
	</div>
</div>
